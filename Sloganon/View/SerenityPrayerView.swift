...
struct SerenityPrayerView: View {
    ...
    @State private var showingAcceptItSheet = false
    @State private var showingCanIChangeItSheet: Bool = false
    @State private var showingThingOneSheet: Bool = false
    @State private var showingChangeItSheet: Bool = false
    @State private var showingThingTwoSheet: Bool = false
    ...
    var body: some View {
        VStack {
            ...
            HStack(spacing:0){
                ...
                VStack(spacing: 0) {
                    ...
                    Button(action: {
                        showingCanIChangeItSheet.toggle()
                    }) {
                        Diamond()
                            .fill(Color.green)
                            .frame(width: ShapeVStackWidth, height: stdHeight)
        ...
        .sheet(isPresented: $showingAcceptItSheet) {
            AcceptItSheetView()
        }
        .sheet(isPresented: $showingCanIChangeItSheet) {
            CanIChangeItSheetView()
        }
        .sheet(isPresented: $showingChangeItSheet) {
            ChangeItSheetView()
        }
        .sheet(isPresented: $showingThingOneSheet) {
            ThingOneSheetView()
        }
        .sheet(isPresented: $showingThingTwoSheet) {
            ThingTwoSheetView()
        }
    }
}
